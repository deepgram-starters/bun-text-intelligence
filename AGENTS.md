# bun-text-intelligence

Bun demo app for Deepgram Text Intelligence.
...
```
feat(bun-text-intelligence): add diarization support
fix(bun-text-intelligence): resolve WebSocket close handling
refactor(bun-text-intelligence): simplify session endpoint
